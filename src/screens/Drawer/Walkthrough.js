...
//            }}>
//            <Tab.Screen name="ALLTRADE" component={AllTrade} />
//            <Tab.Screen name="FNOINDEX" component={FnoIndex} />
//            <Tab.Screen name="FNOEQUITY" component={FnoEquity} />
//            <Tab.Screen name="EQUITYCASH" component={EquityCash} />
//          </Tab.Navigator>
//        </View> */}
//        {/* <====================Circle ==============> */}
//        <View style={{borderBottomWidth: 1}}>
...
//          <View style={styles.bgarea2}>
//            <View style={styles.botomview1}>
//              <Text style={styles.bottomText}>Quantity & investment Amount</Text>
//              <Text style={styles.bottomText1}>100 Lots(10 Qty) = ₹ 1000</Text>
//            </View>
//            <View style={styles.botomview2}>
//              <Text style={styles.bottomText}>P&L</Text>
